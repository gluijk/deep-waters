...
NFRAMES=1752  # 73.00s audio track at 24fps
...
for (frame in 0:(NFRAMES-1)) {
    ...
    map[,,1][water]=(WATERMAX-WATERMIN)*map[,,1][water]+WATERMIN  # lower water contrast
...
Offset=1752  # previously generated frames
NFRAMES=435  # 18.13s audio track at 24fps
...
# Building MP4:
# ffmpeg -framerate 24 -i img%4d.png -i oblivionwakingup.wav
#        -c:v libx264 -crf 18 -pix_fmt yuv420p deepwaterseuropa.mp4
